...
With this final product, we have been able to successfully express visual ideas and how those ideas affect real users, as well as test the feasibility of actual digital infrastructure design. We have expressed a throughout and research-based plan for the next iteration of this app, which will ideally be shippable as a final product, and are excited by the impact it could have on the lives of young people. We are passionate about this issue and believe that we have taken actionable steps towards creating a tool that young people can use to help bring this issue more light and hopefully give them back the time that they would be missing. 
